...
- architecture-overview.md § 6.6 (security and policy architecture, defense in depth, audit and OPA hook points), § 11.7 (RBAC-floor / OPA-restrictor for approvals), § 14.2 (components A7, B2, B3, B16)
- architecture-backlog.md § 2.2, § 3.9, § 6
- ADR 0018 (RBAC-floor / OPA-restrictor enforcement)
- ADR 0003 (Envoy egress proxy — consumes OPA decisions at the egress hook)
- ADR 0017 (Approval system — OPA elevation of required approval level)
